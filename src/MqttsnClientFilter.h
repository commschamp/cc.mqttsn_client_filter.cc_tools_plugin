...
static_assert(CC_MQTTSN_CLIENT_MAKE_VERSION(2, 0, 1) <= CC_MQTTSN_CLIENT_VERSION, "The version of the cc_mqttsn_client library is too old");
static_assert(CC_TOOLS_QT_MAKE_VERSION(5, 3, 1) <= CC_TOOLS_QT_VERSION, "The version of the cc_tools_qt library is too old");
